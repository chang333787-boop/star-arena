...
### 로그인 / 계정 (수업용, L)
- **학급 명단 6슬롯**: 별명·기본 캐릭터·기본 도구. 학생은 자기 계정을 골라 시작할 수 있어요.
- **운영자(admin)**: PIN `1234` 입력 → 슬롯 이름/캐릭터/도구 관리.
- ⚠️ **PIN 1234는 보안 기능이 아니라 수업 편의용**입니다. 개인정보는 저장하지 않고 별명만 씁니다. 명단은 프로필과 별도로 저장돼 기존 데이터에 영향이 없습니다.
